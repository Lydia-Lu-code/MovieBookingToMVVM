...
class MovieDetailViewController: UIViewController {
    ...
    required init?(coder: NSCoder) {
        self.viewModel = MovieDetailViewModel(movieId: 0) // 預設值
...
//        
//        [posterImageView, titleLabel, releaseDateLabel, durationLabel,
//         overviewTitleLabel, overviewLabel, showTimesButton].forEach { contentView.addSubview($0) }
//        
//        view.addSubview(activityIndicator)
//        
//        // Add target
...
//            
//            // ShowTimesButton
//            showTimesButton.topAnchor.constraint(equalTo: overviewLabel.bottomAnchor, constant: 32),
//            showTimesButton.leadingAnchor.constraint(equalTo: contentGuide.leadingAnchor),
//            showTimesButton.trailingAnchor.constraint(equalTo: contentGuide.trailingAnchor),
//            showTimesButton.heightAnchor.constraint(equalToConstant: 50),
//            showTimesButton.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -32),
//            
//            // ActivityIndicator
//            activityIndicator.centerXAnchor.constraint(equalTo: view.centerXAnchor),
//            activityIndicator.centerYAnchor.constraint(equalTo: view.centerYAnchor)
